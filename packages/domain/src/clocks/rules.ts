...
export const CLOCK_RULES: ClockRule[] = [
  ...
  },
  {
    ...
    warnDays: 21,
    source: 'National Guidance for Child Protection in Scotland 2021, Appendix D',
    sourceRef: 'Within 6 months of the initial CPPM. Some areas hold the first review at 3 months (local practice)',
    confidence: 'high',
    localNote: 'Clydeshore local practice: first review at 3 months is available as a local override in Admin',
  },
  {
