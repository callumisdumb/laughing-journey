...
export const MEETING_TRANSITIONS: Record<MeetingType, MeetingTransition> = {
  ...
  cppm: { completes: ['cp.cppm.initial', 'cp.prebirth.cppm', 'cp.cppm.notice', 'cp.cppm.inquorate.reconvene'], starts: ['cp.coregroup.first', 'cp.cppm.review.first', 'cp.cppm.record.distribute'] },
  'pre-birth-cppm': { completes: ['cp.prebirth.cppm', 'cp.cppm.initial', 'cp.cppm.notice', 'cp.cppm.inquorate.reconvene'], starts: ['cp.coregroup.first', 'cp.prebirth.review', 'cp.cppm.record.distribute'] },
  'cppm-review': { completes: ['cp.cppm.review.first', 'cp.cppm.review.subsequent', 'cp.cppm.notice', 'cp.cppm.inquorate.reconvene'], starts: ['cp.cppm.review.subsequent', 'cp.cppm.record.distribute'] },
