...
const ORDER = ['phase-1', 'phase-2', 'phase-3', 'phase-4', 'phase-5', 'phase-6', 'classification', 'nmds', 'security', 'dialogs', 'layout', 'links', 'sign-in', 'clock', 'create', 'network', 'terminal', 'two-way', 'simulator', 'flows', 'search', 'demo'];
